...
category, layout = Settings.RegisterCanvasLayoutCategory(Memoria.OptionPanel, Memoria.OptionPanel.name, Memoria.OptionPanel.name);
category.ID = Memoria.OptionPanel.name;
